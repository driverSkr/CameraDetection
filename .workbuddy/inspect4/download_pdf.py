...
url = "https://ai.d.gtimg.com/mcp/exports/724676748061593/Hidden%20Camera%20Detector%20%E2%80%94%20UI%20v2%20(Apple%20System)-20260911_173050788.pdf?sign=d4b9b37c1d912577aa678bc970af5fbc&t=1791711050"
...
lines = []
lines.append("Output path: " + out)
lines.append("Output dir exists: " + str(os.path.isdir(os.path.dirname(out))))
